...
namespace Patlus.IdentityManagement.UseCaseTests.Features.Pools.Exist.ExistQueryHandlerTests
{
    ...
    public sealed class Handle_Should_Check_Requested_Pools : IDisposable
    {
        private readonly Mock<IMasterDbContext> _mockMasterDbContext;

        public Handle_Should_Check_Requested_Pools()
        {
        ...
        [Theory(DisplayName = nameof(Handle_Should_Check_Requested_Pools))]
