...
namespace Patlus.IdentityManagement.UseCaseTests.Features.Identities.UpdateOwnPassword.UpdateOwnPasswordCommandValidatorTests
{
    ...
    public sealed class Validate_RetypeNewPassword_Should_Return_NotEmpty_Error
    {
        private readonly Mock<IMasterDbContext> _mockMasterDbContext;
        private readonly Mock<IPasswordService> _mockPasswordService;


        public Validate_RetypeNewPassword_Should_Return_NotEmpty_Error()
        {
            _mockMasterDbContext = new Mock<IMasterDbContext>();
            _mockPasswordService = new Mock<IPasswordService>();
        }

        [Theory(DisplayName = nameof(Validate_RetypeNewPassword_Should_Return_NotEmpty_Error))]
        ...
        class TestData : TheoryData<string, UpdateOwnPasswordCommand>
        {
            public TestData()
            {
                ...
                Add(
                    ...
                    new UpdateOwnPasswordCommand()
                    {
                        RetypeNewPassword = string.Empty,
                    }
                );
            }
        }
