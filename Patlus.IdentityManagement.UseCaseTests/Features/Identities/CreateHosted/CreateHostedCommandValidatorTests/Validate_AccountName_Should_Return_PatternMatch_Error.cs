...
namespace Patlus.IdentityManagement.UseCaseTests.Features.Identities.CreateHosted.CreateHostedCommandValidatorTests
{
    ...
    public sealed class Validate_AccountName_Should_Return_PatternMatch_Error
    {
        ...
        [Theory(DisplayName = nameof(Validate_AccountName_Should_Return_PatternMatch_Error))]
