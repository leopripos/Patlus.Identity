...
namespace Patlus.IdentityManagement.UseCaseTests.Features.Identities.CreateHosted.CreateHostedCommandValidatorTests
{
    ...
    public sealed class Validate_AccountName_Should_Return_MinLength_Error
    {
        private readonly Mock<IMasterDbContext> _mockMasterDbContext;

        public Validate_AccountName_Should_Return_MinLength_Error()
        {
            _mockMasterDbContext = new Mock<IMasterDbContext>();
        }

        [Theory(DisplayName = nameof(Validate_AccountName_Should_Return_MinLength_Error))]
