...
namespace Patlus.IdentityManagement.RestTests.Features.Pools
{
    ...
    public sealed class PUT_ACTIVE_Should_Return_Success_And_Updated_Pool : IntegrationTesting
    {
        public PUT_ACTIVE_Should_Return_Success_And_Updated_Pool(TestWebApplicationFactory<Startup> factory)
            : base(factory)
        { }

        [Fact(DisplayName = nameof(PUT_ACTIVE_Should_Return_Success_And_Updated_Pool))]
