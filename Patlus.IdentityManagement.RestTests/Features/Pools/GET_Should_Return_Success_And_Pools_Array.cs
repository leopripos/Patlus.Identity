...
namespace Patlus.IdentityManagement.RestTests.Features.Pools
{
    ...
    public sealed class GET_Should_Return_Success_And_Pools_Array : IntegrationTesting
    {
        public GET_Should_Return_Success_And_Pools_Array(TestWebApplicationFactory<Startup> factory)
            : base(factory)
        { }

        [Fact(DisplayName = nameof(GET_Should_Return_Success_And_Pools_Array))]
