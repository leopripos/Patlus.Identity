...
namespace Patlus.IdentityManagement.Rest.Features.Identities
{
    ...
    public class IdentitiesController : ControllerBase
    {
        ...
        /// </summary>
        /// <returns>List of identity</returns>
        [HttpGet]
        ...
        public async Task<ActionResult<IdentityDto>> Create(Guid poolId, [FromBody] CreateForm form)
        {
            ...
            if (form.AccountName is null) throw new ArgumentNullException(nameof(form.AccountName));
            if (form.AccountPassword is null) throw new ArgumentNullException(nameof(form.AccountPassword));
