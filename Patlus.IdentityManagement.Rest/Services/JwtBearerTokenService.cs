...
namespace Patlus.IdentityManagement.Rest.Services
{
    ...
    {
        private readonly IOptions<ApplicationAuthenticationOptions> _authOptions;
        private readonly ITimeService _timeService;
        private readonly ITokenCacheService _tokenCacheService;

        public JwtBearerTokenService(IOptions<ApplicationAuthenticationOptions> authOptions, ITimeService timeService, ITokenCacheService tokenCacheService)
        {
