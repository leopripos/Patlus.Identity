...
using Patlus.IdentityManagement.IntegrationDispatcher.Dispatchers.Identities;
...
namespace Patlus.IdentityManagement.IntegrationDispatcherTests.Dispatchers.Identities
{
    [Trait("UT-Class", "Dispatchers/Identities/OwnPasswordUdpatedNotificationDispatcherTests")]
    public sealed class OwnPasswordUdpatedNotificationDispatcherTests : IDisposable
    {
        private readonly Mock<IEventDispatcher> _mockEventDispatcher;
        private readonly IMapper _mapper;

        public OwnPasswordUdpatedNotificationDispatcherTests()
        {
        ...
        public async Task Handle_Should_Dispatch_Right_Data()
        {
            ...
            var expectedDto = new OwnPasswordUdpatedNotificationDto()
            {
                Id = identityId,
                By = by,
                Time = time
            ...
            var dispatcher = new OwnPasswordUdpatedNotificationDispatcher(
            ...
            _mockEventDispatcher.Verify(
                d => d.DispatchAsync(
                        ...
                        It.Is<OwnPasswordUdpatedNotificationDto>(e =>
                            e.Id == expectedDto.Id
                            && e.By == expectedDto.By
